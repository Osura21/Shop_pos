...
async function fetchFeatured() {
    loading.value = true
    try {
        const res = await axios.get(route("multivendor.vehicles.brand-new"))
        console.log(res)
...
<template>
    <section v-if="brandNewCars.length" class="py-5 bg-white">
        <div class="container py-5">
            ...
            <div v-else class="row g-4">
                ...
                <div v-if="!brandNewCars.length" class="text-center text-muted py-5">
